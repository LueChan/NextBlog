              ...
              >
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    className="flex items-center rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover:bg-gray-600" rel="noreferrer"
                  >
