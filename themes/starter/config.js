...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/logo2.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/logo-white2.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_BUTTON_2_TEXT: '开始了解', // 英雄区按钮
  STARTER_HERO_BUTTON_2_URL: 'https://www.luechan.com/archive', // 英雄区按钮
  STARTER_HERO_BUTTON_2_ICON: '/images/starter/cat.svg', // 英雄区按钮2的图标，不需要则留空
